...
This project uses supervised machine learning to classify penguin species from the Palmer Penguins dataset. It demonstrates a complete end‑to‑end workflow: data cleaning, exploratory data analysis (EDA), model building, evaluation.
...
## Models Used
This project uses a Decision Tree Classifier from scikit‑learn to predict penguin species based on their physical measurements. The notebook applies several machine learning and data analysis techniques, including:
